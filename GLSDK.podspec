...
Pod::Spec.new do |s|
  s.name             = 'GLSDK'
  s.version          = '1.0'
  s.summary          = 'A short description of GLSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/GeiLe365/GLSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dfs930@365gl.com' => 'dfs930@365gl.com' }
  s.source           = { :git => 'https://github.com/GeiLe365/GLSDK.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'
  #s.static_framework = true
  s.source_files = 'GLSDK/Classes/**/*'

  s.vendored_frameworks = 'GLSDK/Classes/*.framework'
